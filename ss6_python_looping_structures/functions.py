...
def get_requirements():
    ...
    print("\nProgram Requirements:\n"
          + "1. Print while loop.\n"
          + "2. Print for loops using rnage() function, and implicit and explicit lists.\n"
...
def print_loops():
    ...
    # calling it with two arguements creates sequence of numbers from first to second, not including second
    # [1, 2, 3]
    for i in range(1,4):
        print(i)
        
    print("\n4. for loop: using range() function with three args (interval 2):")
    # thrid arguement is interval
    # [1,3]
